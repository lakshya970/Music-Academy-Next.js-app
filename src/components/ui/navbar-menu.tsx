  ...
  return (
    <div onMouseEnter={() => setActive(item)} className="relative ">
      <motion.p
        ...
        className="cursor-pointer text-black hover:text-white dark:text-white"
      >
        {item}
      </motion.p>
      {active !== null && (
...
export const HoveredLink = ({ children, ...rest }: any) => {
  return (
    <Link
      {...rest}
      className="text-neutral-700 dark:text-neutral-200 hover:text-slate-400 duration-200 "
    >
      {children}
    </Link>
  );
